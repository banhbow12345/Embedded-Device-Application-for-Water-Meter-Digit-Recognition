...
# A = [1:123]
for i in range(198):
    img_path = 'C:/Users/ADMIN/Downloads/datanumber2/2/picture'+str(i+1)+'.jpg'
    ...
    binary_img_name = 'picture_3_binary'+str(i+1)+'.jpg' 
    ...
    erosion_img_name = 'picture_3_dilation'+str(i+1)+'.jpg'
